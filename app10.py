  ...
  dcc.Tabs(id="Tabs", value="tab-1",children=[
      ...
      dcc.Tab(label = "Chart Tool", id="chart tool", value="Chart", children=[
          dcc.Tabs(id = "subtabs2", value = "tab-1",children = [
              dcc.Tab(label="World Chart tool", id="WorldC", value="tab-1"),
              dcc.Tab(label="India Chart tool", id="IndiaC", value="tab-2")]),
              html.Div()
              ])
      ])
  ])
...
def update_app_ui(month_value, date_value,region_value,country_value,state_value,city_value,attack_value,year_value,Tab, subtabs):
